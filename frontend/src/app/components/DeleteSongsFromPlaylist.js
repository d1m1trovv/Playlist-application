...
const DeleteSongsFromPlaylist = (props) => {
    ...
    useEffect(() => {
        RequestsService.getSongsToDelete(props.match.params.id).then(
            (response) => {
    ...
    const deleteSongFromPlaylist = (song) => {
        RequestsService.deleteSongFromPlaylist(props.match.params.id, song)
            .then(response => {
                console.log(response.data);
                        ...
                        songs.map((song, index) => (
                            ...
                            >
                                ...
                                <td>{showPopUp && currentSongIndex === index ?
                                    <DeleteIcon
                                        onClick={() => deleteSongFromPlaylist(song)}
                                    />
                                    : null
                                }</td>
                            </tr>
